...
MyGame = ig.Game.extend({
	...
	init: function() {
		...
		this.myDirector = new ig.Director(this, [LevelWelcome, LevelTest, LevelLevel1, LevelLevel2, LevelLevel3, LevelTest2, LevelSwordonly1, LevelSwordonly2, LevelTest3, LevelAstralbody]);
		// Load initial level
