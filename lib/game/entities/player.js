...
EntityPlayer = ig.Entity.extend({
	...
	handlePrimaryEquiping: function() {
		if (ig.input.state('sword') && this.equipCooldown.delta() > 0) {
			this.primary = 'sword';
			this.equipCooldown.set(.5);
		}
		else if (ig.input.state('fist') && this.equipCooldown.delta() > 0) {
	...
	handleSecondaryEquiping: function() {
		if (ig.input.state('boomerang') && this.equipCooldown.delta() > 0) {
			this.secondary = 'boomerang';
			this.equipCooldown.set(.5);
		}
		else if (ig.input.state('bow') && this.equipCooldown.delta() > 0) {
			this.secondary = 'bow';
			this.equipCooldown.set(.5);
		}
		else if (ig.input.state('grapplinghook') && this.equipCooldown.delta() > 0) {
			this.secondary = 'grapplinghook';
			this.equipCooldown.set(.5);
		}
		else if (ig.input.state('magiccloak') && this.equipCooldown.delta() > 0) {
			this.secondary = 'magiccloak';
			this.equipCooldown.set(.5);
		}
		else if (ig.input.state('magicwand') && this.equipCooldown.delta() > 0) {
	...
	check: function(other) {
		if(!(other instanceof EntityPeg || other instanceof EntityIceball)) {
	...
	draw: function() {
		if(this.inGame) {
			...
			var playerCoinCountString = "Coins: " + this.coinCount;
			this.font.draw(playerCoinCountString, 10, 56, ig.Font.ALIGN.LEFT);

			if (this.primary == 'sword') {
				this.font.draw('Sword +' + this.swordLevel + ' Equipped', 10, 79, ig.Font.ALIGN.LEFT);
			}
			else if (this.primary == 'fist') {
				this.font.draw('Fist +' + this.firefistLevel +' Equipped', 10, 79, ig.Font.ALIGN.LEFT);
			}
			else if (this.primary == 'firefist') {
				this.font.draw('FireFist +5 Equipped', 10, 79, ig.Font.ALIGN.LEFT);
			}

			if (this.secondary == 'boomerang') {
				this.font.draw('Boomerang +' + this.boomerangLevel + ' Equipped', 10, 102, ig.Font.ALIGN.LEFT);
			}
			else if (this.secondary == 'bow') {
				this.font.draw('Bow +' + this.bowLevel + ' Equipped', 10, 102, ig.Font.ALIGN.LEFT);
			}
			else if (this.secondary == 'grapplinghook') {
				this.font.draw('Grappling Hook +' + this.grapplinghookLevel + ' Equipped', 10, 102, ig.Font.ALIGN.LEFT);
			}
			else if (this.secondary == 'magiccloak') {
				this.font.draw('Magic Cloak +' + this.magiccloakLevel + ' Equipped', 10, 102, ig.Font.ALIGN.LEFT);
			}
			else if (this.secondary == 'magicwand') {
				this.font.draw('Magic Wand +' + this.magicwandLevel + ' Equipped', 10, 102, ig.Font.ALIGN.LEFT);
			}
		}
	},
