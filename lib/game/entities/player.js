	...
	draw: function() {
		if(this.inGame) {
			...
			if (this.primary == 'sword') {
				this.font.draw('Sword Equipped', 10, 79, ig.Font.ALIGN.LEFT);
			}
			else if (this.primary == 'fist') {
				this.font.draw('Fist Equipped', 10, 79, ig.Font.ALIGN.LEFT);
			}

			if (this.secondary == 'boomerang') {
				this.font.draw('Boomerang Equipped', 10, 102, ig.Font.ALIGN.LEFT);
			}
			else if (this.secondary == 'bow') {
				this.font.draw('Bow Equipped', 10, 102, ig.Font.ALIGN.LEFT);
			}
			else if (this.secondary == 'grapplinghook') {
				this.font.draw('Grappling Hook Equipped', 10, 102, ig.Font.ALIGN.LEFT);
			}
			else if (this.secondary == 'magiccloak') {
				this.font.draw('Magic Cloak Equipped', 10, 102, ig.Font.ALIGN.LEFT);
			}
		}
	},
