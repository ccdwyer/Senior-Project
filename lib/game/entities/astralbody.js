...
EntityAstralbody = ig.Entity.extend({
	...
	receiveDamage: function(amount, from) {
		if(this.invulnerableTimer.delta() > 0) {
			...
			if(this.bombardmentHealth >= this.health) {
				this.bombardmentHealth -= 500;
				ig.game.spawnEntity(EntityEnergybombardmenttarget, this.pos.x+20, this.pos.y+20);
				ig.game.addMessage("You pesky warrior!  That hurts!  TAKE THIS!");
			}
		}
