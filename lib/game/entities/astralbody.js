	...
	handleCombat: function() {
		if(this.movementTimer.delta() > 0) {
			...
			if(this.energyTrapTimer.delta() > 0) {
				...
				if(this.health > 3700)
					this.volleyTimer.set(30);
				else if(this.health > 2500)
					this.volleyTimer.set(15);
				else
					this.volleyTimer.set(10);
				this.spellTimer.set(1);
				...
				ig.game.spawnEntity(EntityEnergybeam, this.pos.x+20, this.pos.y+20, 
					{vel: {x: 0, 
							y: -424}, hasAimed: true});
				if(this.health > 3500)
					this.explosionTimer.set(15);
				else if(this.health > 2000)
					this.explosionTimer.set(10);
				else
					this.explosionTimer.set(5);
				this.spellTimer.set(1);
			}
		}
	},
